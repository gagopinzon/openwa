...
- Nombre del lead: usa SOLO el nombre del CV / pitch. NUNCA uses el alias o nombre de perfil de WhatsApp (pushName), aunque aparezca en el chat o en el historial.`;
